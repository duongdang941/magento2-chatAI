...
- For an unauthenticated shopper, call the appropriate guest-order tool even when no verified email is available. The tool/API is the authority and will return guest_access_required so the gateway can open the secure verification card.
