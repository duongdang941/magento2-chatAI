    ...
    modules.voiceMethods = function (context) {
        ...
        return {
            ...
            async startVoiceDictation() {
                this.voiceError = '';
                if (typeof window.MediaRecorder !== 'function') { this.handleVoiceError('Voice dictation is not supported by this browser.'); return; }                this.voiceState = 'requesting_permission';
            ...
            async finalizeVoiceRecording() {
                ...
                try {
                    ...
                    if (!this.socket || !this.wsConnected) throw new Error('The secure chat connection is unavailable. Voice dictation does not place a phone call; it records locally and sends the clip for transcription.');
            ...
            resetVoiceDictation() {
                ...
                this.voiceRequestId = '';
                this.voiceError = '';
                if (typeof window.MediaRecorder !== 'function') { this.handleVoiceError('Voice dictation is not supported by this browser.'); return; }                this.voiceState = 'idle';
            }
        };
    };
